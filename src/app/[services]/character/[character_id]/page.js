        ...
        <main className="p-4">
            <div className='flex flex-col md:flex-row items-start md:space-x-4 space-y-4 md:space-y-0'>
                ...
                <div className='w-full'>
                    <h1 className='text-2xl font-bold font-pro-bold text-pro-red'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='mt-4'>
                            <h2 className='text-lg font-semibold font-pro-medium text-pro-red'>Details:</h2>
                            <p>Age: {character.age}</p>
                            <p>Gender: {character.gender}</p>
                        </div>
                        <div className='mt-4'>
                            <h2 className='text-lg font-semibold font-pro-medium text-pro-red'>Additional Info:</h2>
            ...
            <ScrollArea className='flex flex-nowrap overflow-x-auto whitespace-nowrap py-4'>
                <h2 className='text-lg font-semibold font-pro-medium text-pro-red'>Voice Actors: </h2>
                {voiceActor.map((actor) => (
                    <Card key={actor.id} className='overflow-hidden mx-2 py-2 w-fit text-white border-none inline-block flex-shrink-0'>
                        ...
                        <CardHeader className='space-y-0 p-0 mt-4'>
                            <CardTitle className='px-2 text-md font-bold font-pro-bold text-pro-red line-clamp-1 text-center'>
